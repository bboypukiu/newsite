<?php
/*
$Id: pipes-processor-htmlparser.php 167 2014-02-27 03:05:32Z tungpham $
Plugin Name: WP Pipes Addon HTML Parser Processor
Plugin URI: http://thimpress.com
Description: WP Pipes addon will be used to parser exactly content from any HTML or text.
Version: 1.0
Author: thimpress
Author URI: http://thimpress.com
Type: Processor
Short Name: htmlparser
*/

defined('DS') or define('DS', DIRECTORY_SEPARATOR);
require_once dirname(__FILE__) . DS . 'lib' . DS . 'psc.php';

class WPPipesPro_htmlparser extends ogb_htmlparser_code {
