...
require_once OBGRAB_ADMIN . DS . 'includes' . DS . 'form' . DS . 'fields' . DS . 'textarea.php';
	...
	protected function getInput() {
		...
		$script = '<script type="text/javascript">
					...
					function checkitout(el){
						...
						var input_url = el.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.parentNode.getElementsByClassName("obkey")[0].textContent;
						if(input_url == "Click me"){
						 	...
						 	for(var i=0;i<list_li.length;i++){
								...
								var exact_text = first_innertext.split(">")[1].trim();
						 		if (input_url.trim() == exact_text){
						 			value_input = list_li[i].getElementsByTagName("p")[0].textContent;
									break;
						 		}
							}
							...
							var url = encodeURI("http://demo.foobla.com/html_parser/index.php?url="+value_input+"&code="+textarea+"&auto_fulltext="+auto_fulltext+"&input=0&curl=1&clear_space=1&charset=utf-8&addvars=&useragent=&clear_tags=&get_cache=0");
							window.open(url);
